...
import com.dropslot.user.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    @org.springframework.beans.factory.annotation.Value("${cors.allowed-origins:${security.cors.allowed-origins:*}}")
