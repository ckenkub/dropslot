...
public class StoreController {
    ...
    @PostMapping
    public ResponseEntity<StoreDtos.StoreResponse> create(@Valid @RequestBody StoreDtos.CreateStoreRequest req,
    ...
    @PutMapping("/{id}")
    public ResponseEntity<StoreDtos.StoreResponse> update(@PathVariable("id") UUID id,
                                                          @Valid @RequestBody StoreDtos.CreateStoreRequest req) {
        return ResponseEntity.ok(storeService.update(id, req));
    }

    @PostMapping("/{id}/branches")
    public ResponseEntity<StoreDtos.BranchResponse> addBranch(@PathVariable("id") UUID id,
                                                              @Valid @RequestBody StoreDtos.CreateBranchRequest req) {
